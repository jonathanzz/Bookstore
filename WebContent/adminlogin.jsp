			...
			<div class="panel-body">
				<form class="form-signin" action="admin" method="post">
					...
					<input type="text" class="input-block-level" name="name" 
						placeholder="User Name"> <input type="password" name="password"
						class="input-block-level" placeholder="Password"> <input
						class="btn btn-large btn-primary" type="submit" value='Sign In' /><input
						type="hidden" name="admin" value="login" />
				</form>
			</div>
		</div>
	</div>
